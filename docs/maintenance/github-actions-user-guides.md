...
3. An admitted request dispatches `generate-project-owner-request.yml`, which
   ...
   - a maintainer review PR containing only the operation's allowed paths
4. Reviewers approve by merging the generated PR. Automatic merge is never
   performed.
...
### 9.2 Build and maintain the generated project review PR

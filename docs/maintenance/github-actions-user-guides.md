...
4. Required CI and `publish-project-transaction.yml` automatically publish a
   still-authorized exact transaction.
5. `project-owner-request-lifecycle.yml` synchronizes the merged or declined PR

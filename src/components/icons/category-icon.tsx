...
export function CategoryIcon({
  ...
  if (name === "chevron") {
    return (
      <svg {...strokeProps} viewBox="0 0 24 24" {...props} data-icon="chevron">
        <path d="m6 9 6 6 6-6" />
      </svg>
    );
  }
  if (name === "filter" || name === "filter-lines") {
    return (
      <svg {...strokeProps} viewBox="0 0 24 24" {...props} data-icon={name}>
  ...
  if (name === "collapse") {
    return (
      <svg {...strokeProps} viewBox="0 0 32 32" {...props} data-icon="collapse">
